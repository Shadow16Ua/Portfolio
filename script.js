...
const translations = {
    en: {
        ...
        edu_goal: "I am actively looking for an IT internship or junior position. My goal is to bring value to a team, solve real-world problems, and fulfill my university requirement of 240 hours of professional practice. Plus, it's a great opportunity to earn money to fund my next hardware upgrades.",
    ...
    uk: {
        ...
        edu_goal: "Я активно шукаю стажування або позицію Junior. Моя мета — приносити користь команді та допомагати створювати круті продукти, а також закрити вимогу університету щодо 240 годин професійної практики. Ну і, звісно, це чудова можливість заробити на оновлення робочого заліза.",
    ...
    pl: {
        ...
        edu_goal: "Aktywnie poszukuję stażu lub stanowiska Junior. Moim celem jest wnoszenie wartości do zespołu i pomoc w rozwiązywaniu rzeczywistych problemów, a także zaliczenie 240 godzin obowiązkowych praktyk studenckich. Dodatkowo jest to świetna okazja, aby zarobić na nowy sprzęt do pracy.",
